...
public class JwtService {
    ...
    public String generateToken(UserDetails userDetails) {
        return generateTokenWith(new HashMap<>(), userDetails);
    }

    // Map<String, Object> ဟု ပြင်ဆင်ထားသည်
    public String generateTokenWith(Map<String, Object> extractClaims, UserDetails userDetails) {
        return Jwts.builder()
